        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link active"  href="#" ><i class="icon icon-plus-circle"></i> Add New Sub Category</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    <form action={{URL::to('admin/add-sub_category')}} method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group m-0">
                                            ...
                                            <input id="name" placeholder="Enter Banner Name" name="subCategoryName" class="form-control r-0 light s-12 " type="text" required>
                                        </div>
                                        
                                        <div class="col-md-12 mb-12 px-0 mt-2">
                                            <label for="brand">Status</label>
                                            <select id="brand" class="custom-select form-control" name="status">
