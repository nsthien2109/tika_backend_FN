...
<div class="page has-sidebar-left">
    ...
    <div class="container-fluid animatedParent animateOnce my-3">
        <div class="animated fadeInUpShort">
            <form id="needs-validation" novalidate method="POST" action={{URL::to('admin/add-address')}} enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-8 ">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="brand" class="custom-select form-control" name="id_user" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="addressProvince" id="validationCustom01"
                                       placeholder="Address Province" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="addressDistrict" id="validationCustom01"
                                       placeholder="Address District" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="addressCommune" id="validationCustom01"
                                       placeholder="Address Commune" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="addressSpecific" id="amount" required>
                                <div class="invalid-feedback">
